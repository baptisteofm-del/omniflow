...
export function DemoPosting() {
  const [timeLeft, setTimeLeft] = useState(9034)
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'posted':
        return { bg: 'bg-green-500/20', border: 'border-green-500/50', text: 'text-green-400', label: 'Posted' }
      case 'scheduled':
        return { bg: 'bg-amber-500/20', border: 'border-amber-500/50', text: 'text-amber-400', label: 'Scheduled' }
      default:
        return { bg: 'bg-gray-500/20', border: 'border-gray-500/50', text: 'text-gray-400', label: 'Paused' }
    }
  }
    ...
    >
      <div className="rounded-2xl overflow-hidden border border-purple-500/30 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl shadow-2xl shadow-purple-900/50">
        ...
        <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 border-b border-purple-500/20 px-4 py-3 flex items-center gap-3">
          ...
          <span className="text-gray-400 text-xs font-medium ml-auto">Posting Automatique</span>
        </div>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm">Gerez 100 profils sur AdsPower, GeeLark et bien d'autres</p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  {profile.status === 'posted' && (
                    <div className="text-xs text-gray-300">+{profile.views}K eyes</div>
                  )}
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-cyan-400">Next post</span>
              </div>
              <div className="text-2xl font-bold text-white font-mono">{formatTime(timeLeft)} Clock</div>
            </motion.div>
            ...
            >
              <div className="text-xs font-semibold text-purple-400 mb-2">Active profiles</div>
              <div className="space-y-1">
                <div className="text-sm text-white">AdsPower (47)</div>
                <div className="text-sm text-white">GeeLark (23)</div>
              </div>
            </motion.div>
            ...
            >
              <div className="text-xs font-semibold text-green-400 mb-2">Posts today</div>
