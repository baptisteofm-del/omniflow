...
const testimonials = [
  {
    id: 1,
    text: 'En 3 semaines on a supprimé 2 VAs et on poste 3x plus. Le ROI est dingue.',
    author: 'Marco D.',
  ...
  {
    id: 2,
    text: 'La génération IA de Kling est folle. Nos Reels font +40% d\'engagement.',
    author: 'Sarah M.',
  ...
  {
    id: 3,
    text: 'L\'analyse des fans mécontents nous a sauvé 3 gros abonnés ce mois-ci.',
    author: 'Thomas R.',
    company: 'ScaleOF',
    initials: 'TR',
  ...
  {
    id: 4,
    text: 'Setup en 20 min, premier post automatique dans l\'heure. Bluffant.',
    author: 'Julie P.',
    company: 'LuxeAgency',
    initials: 'JP',
  ...
  {
    id: 5,
    text: 'Le parrainage m\'a ramené 8 agences. Je gagne 800€/mois juste avec ça.',
    author: 'Alex K.',
    company: 'FlowAgency',
    initials: 'AK',
