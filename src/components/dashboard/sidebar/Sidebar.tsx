...
export function Sidebar() {
  ...
  const sidebarContent = (
    <>
      {/* Logo */}
      <div className={cn('flex items-center border-b border-white/5 transition-all duration-300', isExpanded ? 'px-5 py-5 gap-3' : 'px-3 py-5 justify-center')}>
      ...
      {/* Nav */}
      <nav className="flex-1 overflow-y-auto overflow-x-hidden py-4 px-2 space-y-0.5 scrollbar-none">
