  ...
  return (
    <div className="min-h-screen py-24 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-2 gradient-text">Conditions Générales d'Utilisation</h1>
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>L'utilisation du Service implique l'acceptation pleine et entière des présentes CGU. Si vous n'acceptez pas ces conditions, vous ne devez pas utiliser le Service. Ces CGU peuvent être modifiées à tout moment ; les utilisateurs seront notifiés par email de toute modification substantielle.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">3. Accès au service</h2>
            <p>Le Service est réservé aux professionnels (agences, auto-entrepreneurs) exerçant une activité légale. L'utilisateur garantit avoir la capacité juridique pour souscrire aux présentes CGU. Un essai gratuit de 7 jours est proposé sans engagement. Passé ce délai, l'accès est conditionné à la souscription d'un abonnement payant.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">4. Abonnements et facturation</h2>
            <p>Les abonnements sont proposés en formules mensuelle et annuelle. Le paiement est traité par Paddle (carte bancaire) ou NOWPayments (cryptomonnaies). Les prix sont affichés TTC. En cas de non-paiement, l'accès au Service peut être suspendu. L'annulation prend effet à la fin de la période d'abonnement en cours.</p>
          </section>
          ...
          <section>
            ...
            <p>Les présentes CGU sont soumises au droit français. Tout litige relatif à leur interprétation ou exécution sera soumis aux tribunaux compétents de Paris, sauf disposition légale contraire.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">11. Contact</h2>
            <p>Pour toute question relative aux présentes CGU : <strong>legal@omniflowapp.ai</strong></p>
          </section>
        </div>
      </div>
    </div>
