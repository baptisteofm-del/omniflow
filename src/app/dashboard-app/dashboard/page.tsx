...
import { ChevronLeft, ChevronRight, TrendingUp, Users, Zap, Target, MessageSquare } from 'lucide-react'
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <p className="text-xs text-gray-400">Evolution du CA sur la période</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-600/20 to-cyan-600/20 border border-purple-500/30 rounded-2xl p-8 text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Chatting IA</h2>
        <p className="text-gray-400 mb-6">Gérez les conversations avec vos fans grâce à l'IA</p>
        <a href="/dashboard-app/chatting-ia" className="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition">
          Ouvrir le Chatting IA →
        </a>
      </div>
    </div>
  )
