...
const TOOLS = [
  ...
  },
  {
    ...
    label: 'MYM',
    color: '#000000',
    logo: <span className="text-white text-xs font-bold">MYM</span>,
  ...
  },
  {
    ...
    label: 'AdsPower',
    color: '#2563eb',
    logo: <span className="text-white text-xs font-bold">A</span>,
  ...
  },
  {
    ...
    label: 'GeeLark',
    color: '#059669',
    logo: <span className="text-white text-xs font-bold">G</span>,
